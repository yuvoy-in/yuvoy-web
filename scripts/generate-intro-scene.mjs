...
// (tops ~y 720) and the brightest water glint (~y 780-840). A full-bottom
// crop (down to y 941, baked label mirrored out) was tried on 2026-08-06
// and reverted the same day: the owner preferred this tighter band.
const BAND_TOP = 655;
