  ...
  return (
    <ul className="grid grid-cols-2 gap-2 sm:grid-cols-3">
      {STACK.map((app) => (
        <li
          key={app.tool}
          className="border-cream-line bg-cream-deep rounded-edge after:bg-terra relative border px-3 py-4 text-center after:absolute after:top-[42%] after:right-[12%] after:left-[12%] after:h-px"
        >
