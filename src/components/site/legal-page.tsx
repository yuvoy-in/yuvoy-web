...
export function LegalPage({
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 sm:px-10 sm:py-24">
      ...
      <h1 className="font-display text-forest mt-6 text-[clamp(2rem,5vw,3rem)] leading-[1.05] font-extrabold tracking-tight">
        {title}
      </h1>
...
export function LegalSection({
  ...
  return (
    <section>
      <h2 className="font-display text-forest text-xl font-bold tracking-tight">
        {heading}
      </h2>
