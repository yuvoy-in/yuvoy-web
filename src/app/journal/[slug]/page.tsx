...
const components = {
  h2: (props: React.ComponentProps<"h2">) => (
    <h2
      className="font-display text-forest tracking-display mt-12 text-2xl font-normal first:mt-0"
      {...props}
    />
  ),
  h3: (props: React.ComponentProps<"h3">) => (
    <h3
      className="font-display text-forest tracking-display mt-8 text-xl font-normal"
      {...props}
    />
  ),
  ...
  strong: (props: React.ComponentProps<"strong">) => (
    <strong className="text-forest font-bold" {...props} />
  ),
};
