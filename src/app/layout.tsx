...
import { greatVibes, instrumentSerif, inter, plexMono } from "@/lib/fonts";
  ...
  return (
    <html
      ...
      */
      ...
      className={`${instrumentSerif.variable} ${inter.variable} ${plexMono.variable} ${greatVibes.variable} h-full`}
    >
